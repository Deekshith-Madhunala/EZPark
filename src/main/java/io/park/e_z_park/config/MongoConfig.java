package io.park.e_z_park.config;

import io.park.e_z_park.util.MongoOffsetDateTimeReader;
import io.park.e_z_park.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("io.park.e_z_park.repository")
